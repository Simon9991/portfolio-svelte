...
<div class="flex flex-col mt-10 gap-y-5 max-w-[850px] w-[850px] mx-auto max-h-full overflow-hidden">
    <div class="card-hover self-center max-w-[850px] w-[850px] flex flex-col">
        ...
        <p>
            A software engineer currently living in
            <span class="font-semibold">South Korea</span>. I thrive in solving problems and finding
            solutions.
        </p>
        <p>I am passionate about anything related to code, NeoVim and helping others.</p>
    </div>

    <div class="card mt-4 flex flex-col">
        <h2 class="font-semibold w-fit">Recent Posts</h2>
        ...
        <div class="p-4 overflow-auto flex flex-col gap-4">
            <a href="/blog/svelte-discovery" class="inline-flex gap-4 group cursor-pointer">
                ...
                <div class="block">
                    ...
                    <p class="group-hover:text-white transition-all duration-300">
                        Discover how Svelte transformed my perspective on frontend development,
            ...
            <a href="/blog/rust-and-cpp" class="inline-flex gap-4 group cursor-pointer">
                ...
                <div class="block">
                    ...
                    <p class="group-hover:text-white transition-all duration-300">
                        Dive into the thoughts of a C/C++ fanatic, and see the multiple reasons of
                        using Rust over C/C++ for system programming.
                    </p>
                </div>
            </a>
